...
<body>
    ...
    <div class="header-section">
        <div class="container position-relative">
            <div class="row">
                <div class="col-xl-6 col-md-12 my-xl-5 mb-0 my-sm-3  position-static ">
                    <div class="main-menu d-none d-md-block">
                        <nav>
                            <ul>
                                <li><a href="{{url('/')}}">Home <i class="fas fa-angle-down"></i></a> </li>
                                <li><a href="{{url('/')}}">Dropdown <i class="fas fa-angle-down"></i></a>
                                    <ul class="submenu">
                                ...
                                <li><a href="{{route('shop_view')}}">Shop <i class="fas fa-angle-down"></i></a></li>
                                <li><a href="#">Blogs</a>
                                    <div class="mega-menu">
                                        <ul>
                ...
                <div class="col-xl-4 col-md-8 col-sm-12 mb-0  my-xl-5 text-center text-md-right position-relative">
                            ...
                            <li><a href="#">cart({{$GetTotalQuantity}})</a>
                                  <div class="card-hover p-3">
                                        <table class="table table-dark table-hover table-bordered">
                                                    ...
                                                    <tr>
                                                        <td> <img style="width:100%;height:65px" src="{{asset('uploads/product_images')}}/{{$item->attributes->image}}"  alt=""></td>
                                                        <td> <p>{{$item->name}}</p></td>
                                                        <td>${{$item->price}}<br>
                                                       total: ${{$item->quantity*$item->price}}
                                                        </td>
                                                        <td  class="position-relative">
                                                            <a  class="d-inline position-absolute" href="{{route('cart_product_remove',['product_id'=>$item->id])}}" style="top:-23px;right:13px;"><i class="fas fa-trash-alt text-danger"></i></a>
                                                            <form action="{{route('cart_product_update')}}" method="post" class="mt-4">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <input class="w-100 form-control" type="Number" value="{{$item->quantity}}" min="1" name="product_quantity">
                                                                    <input class="w-100" type="hidden" value="{{$item->id}}" name="product_id">
                                    ...
                                    <div class="total-price clearfix">
                                        ...
                                        <span class="float-right total-right">${{$GetSubTotal}}</span>
                                                                    @php 
                                                                        Session::put(['Subtotal'=>$GetSubTotal]);
                                                                    @endphp
                                    </div>
...
<!--Footer-section start-->
    ...
    <!-- Optional JavaScript -->
<!-- jQuery first, then Popper.{{asset('frontend')}}/js, then Bootstrap JS -->
