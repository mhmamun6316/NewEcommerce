                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('shop_view')}}">Shop</a></li>
                    ...
                    <div class="img-tab-area">
                        <div class="tab-content tab-img">
                            <div class="tab-pane fade show active" id="img1" role="tabpane">
                                <img class="img-fluid" src="{{asset('uploads/product_images')}}/{{$product->product_image}}" alt="">
                            </div>
                            <div class="tab-pane fade" id="img2" role="tabpanel">
                                <img class="img-fluid" src="{{asset('frontend')}}/img/pro-det-tab-img/2.jpg" alt="">
                            </div>
                            <div class="tab-pane fade" id="img3" role="tabpanel">
                                <img class="img-fluid" src="{{asset('frontend')}}/img/pro-det-tab-img/3.jpg" alt="">
                            </div>
                        </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="options-area">
                       ...
                       <form action="{{route('add_to_cart')}}" method="post" class="cart-and-action">
                        ...
                        <div class="cart-pro ">
                            <button class="btn btn-outline-success btn-lg mt-1" type="submit">Add to cart</button>
                        </div>
                     </form>
                </div>
                <!-- options-area End -->
                ...
                <div class="product-active owl-carousel nav-style">
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <a href="{{route('product_details',['id'=>$related_product->id])}}"> <img src="{{asset('uploads/product_images')}}/{{$related_product->product_image}}" alt=""></a>
<!--                            <a href="#"> <img class="secondary-img" src="img/product-img/product1.jpg" alt=""></a>-->
                        ...
                        <div class="product-content text-center">
                            <h3><a href="{{route('product_details',['id'=>$related_product->id])}}">{{$related_product->product_name}}</a></h3>
                            <div class="rating">
                                <i class="fas far fa-star"></i>
                                <i class="fas far fa-star"></i>
                                <i class="fas far fa-star"></i>
