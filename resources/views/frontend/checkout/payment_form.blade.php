          ...
          <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header  mb-3 text-center text-warning">
                            Dear <strong class="text-dark">{{Session::get('shipping_full_name')}}</strong>  .You have to give us product payment method..
                        </div>
                    </div>
          </div>
        </div>
               ...
               <form action="{{route('order_save')}}" method="POST">
                  @csrf
                   <table class="table table-bordered table-hover">
                       ...
                       <tr>
                           <td><a class="btn btn-warning" href="">Shipping Edit</a></td>
